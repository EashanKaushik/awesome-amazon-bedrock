...
| :------------------------------------------------------------- | :------------:| :--------------: | :-------------: | :------------------: |
| Amazon Bedrock Agents                                          | Jully 2023| [:computer:](https://github.com/awslabs/amazon-bedrock-agent-samples/tree/main/examples/amazon-bedrock-agents) | [:scroll:](https://aws.amazon.com/blogs/aws/agents-for-amazon-bedrock-is-now-available-with-improved-control-of-orchestration-and-visibility-into-reasoning/) | [:orange_book:](https://docs.aws.amazon.com/bedrock/latest/userguide/agents-how.html) |
